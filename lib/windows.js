...
const bin = path.join(__dirname, '../geturl.exe');
...
module.exports = async () => {
	...
	if (result !== undefined) {
		const {stdout} = await execFile(bin, [], {encoding: 'utf8'});
		return Object.assign({}, result, parseWinURL(stdout));
	}
